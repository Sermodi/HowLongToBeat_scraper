...
class TestHowLongToBeatScraper:
    ...
    async def test_search_empty_game_name(self):
        ...
        with pytest.raises(ValueError, match="El nombre del juego no puede estar vacío"):
    ...
    async def test_search_timeout(self):
        ...
        with pytest.raises(GameNotFoundError, match="No se pudo cargar la página de resultados"):
