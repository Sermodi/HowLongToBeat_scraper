...
class TestPublicAPI:
    ...
    async def test_get_game_data_async_success(self):
        ...
        with patch('src.howlongtobeat_scraper.api.BrowserManager') as mock_browser_manager:
            mock_page = AsyncMock()
            ...
            with patch('src.howlongtobeat_scraper.api.HowLongToBeatScraper') as mock_scraper_class:
    ...
    async def test_get_game_data_async_scraper_error(self):
        ...
        with patch('src.howlongtobeat_scraper.api.BrowserManager') as mock_browser_manager:
            ...
            with patch('src.howlongtobeat_scraper.api.HowLongToBeatScraper') as mock_scraper:
                mock_scraper.return_value.search.side_effect = GameNotFoundError("Game not found")
